        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              <h1 id="colorlib-logo"><a href="index.html">Lily Chen</a></h1>
              <span className="email"><i className="icon-mail"></i> lilichen@andrew.cmu.edu</span>
            </div>
            ...
            <nav id="colorlib-main-menu">
              <ul>
                ...
                <li><a href="https://www.linkedin.com/in/lilichenprofile/" target="_blank" rel="noopener noreferrer"><i className="icon-linkedin2" /></a></li>
                <li><a href="https://github.com/lilychen0505" target="_blank" rel="noopener noreferrer"><i className="icon-github"></i></a></li>
